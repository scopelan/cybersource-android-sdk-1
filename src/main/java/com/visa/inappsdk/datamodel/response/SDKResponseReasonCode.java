...
/**
 * <b>public enum SDKResponseReasonCode</b>
 * <br><br>
...
public enum SDKResponseReasonCode {
	...
	SDKResponseReasonCode(int code, String description, String shortDisplayableName) {
	...
	/**
	 * <b>public static SDKResponseReasonCode getResponseReasonCodeByValue(int reasonCode)</b>
	 * <br><br>
	 * Get SDKResponseReasonCode object by value.
	 * @param reasonCode
	 * @return
	 */
	public static SDKResponseReasonCode getResponseReasonCodeByValue(int reasonCode) {
		switch (reasonCode) {
		case 100:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_SUCCESSFUL_TRANSACTION;
		case 101:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_ONE_OR_MORE_FIELDS_INVALID;
		case 110:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_PARTIAL_TRANSACTION;
		case 150:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_GENERAL_SYSTEM_FAILURE;
		case 200:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_APPROVED_BUT_DECLINED_BECAUSE_AVS;
		case 201:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_DECLINED_QUESTIONS;
		case 202:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_DECLINED_EXPIRED_CARD;
		case 203:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_DECLINED_GENERAL_DECLINE;
		case 204:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_DECLINED_INSUFICCIENT_FUNDS;
		case 205:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_DECLINED_STOLEN_OR_LOST_CARD;
		case 207:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_DECLINED_ISSUING_BANK_UNAVAILABLE;
		case 208:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_DECLINED_INACTIVE_CARD;
		case 209:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_DECLINED_CVN_DID_NOT_MATCH;
		case 210:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_DECLINED_CARD_CREDIT_LIMIT_REACHED;
		case 211:
			return SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_DECLINED_INVALID_CVN;
		default:
			SDKResponseReasonCode unknownCode = SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_UNKNOWN;
	...
	/**
	 * <b>public static SDKResponseReasonCode getResponseReasonCodeByValueMapping(String reasonCode)</b>
	 * <br><br>
	 * Map value of reason code and return SDKResponseCode object.
	 * 
	 * @param reasonCode
	 * @return properly mapped reason code; if mapping was unsuccessful returns SDKResponseReasonCode.SDK_RESPONSE_REASON_CODE_UNKNOWN with reason code 0
	 */
	public static SDKResponseReasonCode getResponseReasonCodeByValueMapping(String reasonCode) {
		int code = 0;
		if (reasonCode != null) {
			try {
